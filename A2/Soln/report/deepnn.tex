...
\begin{document}
	...
	\begin{figure}[!ht]
		\centering
		\includegraphics[width=.8\linewidth]{img/1/sample.png}
		\caption{Full data}
		\label{fig:sample}
	\end{figure}
	...
	\begin{figure*}[!ht]
		\begin{subfigure}{.33\textwidth}
			\centering
			\includegraphics[width=.35\linewidth]{img/1/5_0.png}
			\caption{$5$ but looks like a $3$}
			\label{fig:incorrect1}
		\end{subfigure}
		\begin{subfigure}{.33\textwidth}
			\centering
			\includegraphics[width=.35\linewidth]{img/1/6_4.png}
			\caption{$6$ but looks like a $4$}
			\label{fig:incorrect2}
		\end{subfigure}
		\begin{subfigure}{.33\textwidth}
			\centering
			\includegraphics[width=.35\linewidth]{img/1/9_9.png}
